  ...
  return (
    ...
    gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <p className='regular-16 mt-16 text-gray-30 xl:max-w-[520px]'>
        We wanted to beon each of your journeys seeking the satisfaction
        of seeing the incorruptible beauty of nature. We can help you on
        an adventure around the word in just one app
      </p>
      ...
      <div className='relative flex flex-1 items-start '>
        ...
        rounded-3xl bg-green-90 px-7 py-8'>
          ...
          <div className='flex flex-col'>
            ...
            <p className='bold-20 text-white'>Kalsubai</p>
          </div>
            ...
            <div className='flexBetween'>
              <div className='flex flex-col'>
                ...
                <p className='bold-20 text-white'>143.69 KM</p>
              </div>
              <div className='flex flex-col'>
